...
OS:
~~~
	_ a computer with a linux (we used Ubuntu 12.0.4 LTS 32 and 64 bits)
	_ a C compiler
	_ bash
	_ admin rights
~~~
Data Base: 
	_ [Postgresql 9.2](http://www.postgresql.org/) 
	_ [Postgis 2.0.3 extension](http://postgis.net/) 
	_ [Pointcloud extension and Pointcloud_postgis extension](https://github.com/pramsey/pointcloud/)
	
Software
	_(optionnal) the modified version of [Diego Nehab's RPly](http://w3.impa.br/~diego/software/rply/) to import points in ply format into database
