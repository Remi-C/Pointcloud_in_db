...
--▓▒░Creating the XML schema corresponding to points acquired by a Riegl Laser and a Velodyn Laser▓▒░--
	...
	--Creating the XML  schema for points acquired by a riegl laser:
			...
			<!-- ply header: (note dimension order is different)
			ply
				...
				property uint num_echo
				property uint nb_of_echo
				property uint label
				property uint class
			end_header
			-->
			...
			<pc:PointCloudSchema xmlns:pc="http://pointcloud.org/schemas/PC/1.1" 
			 ...
			 <pc:dimension>
			   ...
			   <pc:dimension>
			    ...
			    <!-- temps au moment de l'acquisition-->
			   <pc:dimension>
			    <pc:position>4</pc:position>
			    <pc:size>8</pc:size>
			    <pc:description>le temps GPS du moement de l acquisition du points. Note : il faudrait utiliser l offset et s assurer qu il n y a pas de decallage</pc:description>
			   ...
			   <!-- reflectance ie amplitude de rtrour moduloo distance-->
			   <pc:dimension>
			    <pc:position>5</pc:position>
			    <pc:size>4</pc:size>
			   ...
			   <!-- classification : 	property uint label property uint class-->
			 <pc:dimension>
			    <pc:position>6</pc:position>
			    <pc:size>4</pc:size>
			    <pc:description>un etiquette unique par fichier par objet detecté</pc:description>
			    <pc:name>label</pc:name>
			   ...
			   <pc:dimension>
			    <pc:position>7</pc:position>
			    <pc:size>4</pc:size>
			    <pc:description>le typede l objet detecté</pc:description>
			...
			<pc:dimension>
			 ...
			 <!-- mesure geom-->
			  ...
			  <pc:dimension>
			    ...
			    <pc:size>4</pc:size>
			    <pc:description> distance 3D entre laser et point acquis, ajoute par CMM </pc:description>
			    <pc:name>radius</pc:name>
			    <pc:interpretation>float</pc:interpretation>
			    <pc:scale>1</pc:scale>
				<pc:offset>0</pc:offset>
			  </pc:dimension>
